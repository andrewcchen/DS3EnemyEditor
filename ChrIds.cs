...
namespace DS3EnemyEditor
{
    class ChrIDs
    {
        public static string f(string k)
        {
            return m.TryGetValue(k, out string r) ? r : "";
        }

        public static readonly Dictionary<string, string> m = new Dictionary<string, string>
        {
            //{"c0100", "unknown"},
            {"c2020", "Dog"},
            {"c2021", "Dog"},
            ...
            {"c1220", "Reanimated / Infested Corpse"},
            {"c2170", "Company Captin Yorshka"},
            {"c2290", "Dog [Irithyll]"},
            {"c2260", "Ballista"},
            //{"c3071", "unknown [Demon Ruins]"},
            {"c3190", "Blacksmith Andre"},
            {"c6030", "Wolf"},
            {"c6120", "Painting Woman"},
            {"c6121", "Painting Woman"},
            //{"c5021", "unknown"},
            //{"c5022", "unknown"},
            {"c6240", "Angel Host"},
            {"c6250", "Angel"},
            //{"c6232", "unknown (doesn't load?)" },
            {"c6210", "Darkeater Midir (bridge)"},
            //{"c6281", "unknown" },
            {"c6200", "Slave Knight Gael (phase 2)"},
            {"c6201", "Slave Knight Gael (phase 1)"},
            {"c6300", "NPC [Ringed City]"},
            {"c6310", "Filianore"},
            {"c5010", "Nameless King (phase 2)"},
            {"c5030", "Nameless King (phase 1)"},
